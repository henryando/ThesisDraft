...
% Define the content to go in the header
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead{}
\fancyhead[RO,LE]{\nouppercase{\rightmark}} % section number + title
% \fancyfoot{}
% \fancyfoot[C]{\thepage}
...
\makeatother
\fancyhead{}
\fancyhead[RO,LE]{\nouppercase{\leftmark}} % section number + title
\chapter{Conclusions}
...
\fancyhead{}
\fancyhead[RO,LE]{Acknowledgements}
